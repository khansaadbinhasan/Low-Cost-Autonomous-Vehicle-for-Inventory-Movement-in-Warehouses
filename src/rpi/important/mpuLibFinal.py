...
if __name__ == "__main__":
    ...
    TCP_IP = '192.168.43.158' # IP of workstation
    TCP_PORT = 5007
    ...
    while True:
        ...
        try:
            ...
            dataStringAccel = str(accel['x'])+','+str(accel['y'])+','+str(accel['z'])
            dataStringGyro = str(gyro['x'])+','+str(gyro['y'])+','+str(gyro['z'])
            dataStringMag = str(mag['x'])+','+str(mag['y'])+','+str(mag['z'])
            dataStringTemp = str(temp)   

            dataString = dataStringAccel + ',' + dataStringGyro + ',' + dataStringMag + ',' + dataStringTemp
