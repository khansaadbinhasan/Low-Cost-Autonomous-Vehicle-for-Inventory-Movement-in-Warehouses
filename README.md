...
<img src="./READMErsc/graph1.png" width=33% style="float: left;">
<img src="./READMErsc/graph2.png" width=33% style="float: center;">
<img src="./READMErsc/graph3.png" width=33% style="float: right;">
